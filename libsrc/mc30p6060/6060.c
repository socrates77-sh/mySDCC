...
volatile __T1DATA1bits_t __at(T1DATA1_ADDR) T1DATA1bits;
volatile __T1DATA2bits_t __at(T1DATA2_ADDR) T1DATA2bits;
...
volatile __T1DATA0bits_t __at(T1DATA0_ADDR) T1DATA0bits;
