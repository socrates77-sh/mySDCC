...
; This file was generated Tue Nov 14 18:38:45 2017
;--------------------------------------------------------
; MC35 port for the RISC core
;--------------------------------------------------------
;	.file	"../libsdcc_mc35/slong2fs.c"
	list	p=2K7041
	radix dec
	include "2K7041.inc"
;--------------------------------------------------------
...
;;[ICODE] ../libsdcc_mc35/slong2fs.c:33:  _entry($5) :
;;[ICODE] ../libsdcc_mc35/slong2fs.c:33: 	proc ___slong2fs [k1 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{float function ( long-int fixed) fixed}
___slong2fs	;Function start
; 2 exit points
;;[ICODE] ../libsdcc_mc35/slong2fs.c:33: iTemp0 [k2 lr3:12 so:0]{ ia0 a2p0 re1 rm0 nos0 ru0 dp0}{long-int fixed}{ sir@ ___slong2fs_sl_1_21}[r0x1000 r0x1001 r0x1002 r0x1003 ] = recv ___slong2fs [k1 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{float function ( long-int fixed) fixed}
;	.line	33; "../libsdcc_mc35/slong2fs.c"	float __slong2fs (signed long sl) _FS_REENTRANT
	MOVRA	r0x1000
	MOVAR	STK00
	MOVRA	r0x1001
	MOVAR	STK01
...
;;[ICODE] ../libsdcc_mc35/slong2fs.c:36: 	iTemp2 [k6 lr6:7 so:0]{ ia0 a2p0 re0 rm0 nos0 ru1 dp0}{long-int fixed}[r0x1004 r0x1005 r0x1006 r0x1007 ] = - iTemp0 [k2 lr3:12 so:0]{ ia0 a2p0 re1 rm0 nos0 ru0 dp0}{long-int fixed}{ sir@ ___slong2fs_sl_1_21}[r0x1000 r0x1001 r0x1002 r0x1003 ]
;	.line	36; "../libsdcc_mc35/slong2fs.c"	return -__ulong2fs(-sl);
	MOVAI	0xff
	XORAR	r0x1003
	MOVRA	r0x1004
	MOVAI	0xff
...
;;[ICODE] ../libsdcc_mc35/slong2fs.c:36: 	iTemp3 [k8 lr8:9 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{float fixed}[r0x1004 r0x1005 r0x1006 r0x1007 ] = call ___ulong2fs [k5 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{float function ( unsigned-long-int fixed) fixed}
	...
	MOVAR	STK02
	MOVRA	r0x1004
;;[ICODE] ../libsdcc_mc35/slong2fs.c:36: 	iTemp4 [k9 lr9:10 so:0]{ ia0 a2p0 re0 rm0 nos0 ru1 dp0}{float fixed}[r0x1004 r0x1005 r0x1006 r0x1007 ] = - iTemp3 [k8 lr8:9 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{float fixed}[r0x1004 r0x1005 r0x1006 r0x1007 ]
	MOVAR	r0x1007
	XORAI	0x80
	MOVRA	r0x1007
	MOVAR	r0x1006
	...
	MOVAR	r0x1004
	MOVRA	r0x1004
;;[ICODE] ../libsdcc_mc35/slong2fs.c:36: 	ret iTemp4 [k9 lr9:10 so:0]{ ia0 a2p0 re0 rm0 nos0 ru1 dp0}{float fixed}[r0x1004 r0x1005 r0x1006 r0x1007 ]
	MOVAR	r0x1004
	MOVRA	STK02
	MOVAR	r0x1005
	MOVRA	STK01
	...
	MOVAR	r0x1007
	GOTO	_00108_DS_
;;[ICODE] ../libsdcc_mc35/slong2fs.c:36:  _iffalse_0($2) :
;;[ICODE] ../libsdcc_mc35/slong2fs.c:38: 	send iTemp0 [k2 lr3:12 so:0]{ ia0 a2p0 re1 rm0 nos0 ru0 dp0}{long-int fixed}{ sir@ ___slong2fs_sl_1_21}[r0x1000 r0x1001 r0x1002 r0x1003 ]{argreg = 1}
;;[ICODE] ../libsdcc_mc35/slong2fs.c:38: 	iTemp5 [k10 lr13:14 so:0]{ ia0 a2p0 re0 rm0 nos0 ru1 dp0}{float fixed}[r0x1000 r0x1001 r0x1002 r0x1003 ] = call ___ulong2fs [k5 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{float function ( unsigned-long-int fixed) fixed}
_00106_DS_
;	.line	38; "../libsdcc_mc35/slong2fs.c"	return __ulong2fs(sl);
	MOVAR	r0x1003
	MOVRA	STK02
	MOVAR	r0x1002
	MOVRA	STK01
	...
	MOVAR	STK02
	MOVRA	r0x1003
;;[ICODE] ../libsdcc_mc35/slong2fs.c:38: 	ret iTemp5 [k10 lr13:14 so:0]{ ia0 a2p0 re0 rm0 nos0 ru1 dp0}{float fixed}[r0x1000 r0x1001 r0x1002 r0x1003 ]
	MOVAR	r0x1003
	MOVRA	STK02
	MOVAR	r0x1002
	MOVRA	STK01
	...
	MOVRA	STK00
	MOVAR	r0x1000
;;[ICODE] ../libsdcc_mc35/slong2fs.c:38:  _return($4) :
;;[ICODE] ../libsdcc_mc35/slong2fs.c:38: 	eproc ___slong2fs [k1 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{float function ( long-int fixed) fixed}
_00108_DS_
	RETURN	
