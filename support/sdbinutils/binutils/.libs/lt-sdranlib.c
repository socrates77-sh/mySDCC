...
/* ./.libs/lt-sdranlib.c - temporary wrapper executable for .libs/sdranlib.exe
   Generated by libtool (GNU libtool 1.3134 2009-11-29) 2.2.7a

   The sdranlib program cannot be directly executed until all the libtool
   libraries that it depends on are installed.

   This wrapper executable should never be moved out of the build directory.
   If it is, it will not operate correctly.

   Currently, it simply execs the wrapper *script* "/bin/sh sdranlib",
   but could eventually absorb all of the scripts functionality and
   exec .libs/sdranlib.exe directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "sdranlib.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# sdranlib - temporary wrapper script for .libs/sdranlib.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool 1.3134 2009-11-29) 2.2.7a\n", f);
  fputs ("#\n", f);
  fputs ("# The sdranlib program cannot be directly executed until all the libtool\n", f);
