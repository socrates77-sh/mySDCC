...
/* ./.libs/lt-sdar.c - temporary wrapper executable for .libs/sdar.exe
   Generated by libtool (GNU libtool 1.3134 2009-11-29) 2.2.7a

   The sdar program cannot be directly executed until all the libtool
   libraries that it depends on are installed.

   This wrapper executable should never be moved out of the build directory.
   If it is, it will not operate correctly.

   Currently, it simply execs the wrapper *script* "/bin/sh sdar",
   but could eventually absorb all of the scripts functionality and
   exec .libs/sdar.exe directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "sdar.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# sdar - temporary wrapper script for .libs/sdar.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool 1.3134 2009-11-29) 2.2.7a\n", f);
  fputs ("#\n", f);
  fputs ("# The sdar program cannot be directly executed until all the libtool\n", f);
