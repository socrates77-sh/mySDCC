...
/* ./.libs/lt-bfdtest2.c - temporary wrapper executable for .libs/bfdtest2.exe
   Generated by libtool (GNU libtool 1.3134 2009-11-29) 2.2.7a

   The bfdtest2 program cannot be directly executed until all the libtool
   libraries that it depends on are installed.

   This wrapper executable should never be moved out of the build directory.
   If it is, it will not operate correctly.

   Currently, it simply execs the wrapper *script* "/bin/sh bfdtest2",
   but could eventually absorb all of the scripts functionality and
   exec .libs/bfdtest2.exe directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "bfdtest2.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# bfdtest2 - temporary wrapper script for .libs/bfdtest2.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool 1.3134 2009-11-29) 2.2.7a\n", f);
  fputs ("#\n", f);
  fputs ("# The bfdtest2 program cannot be directly executed until all the libtool\n", f);
