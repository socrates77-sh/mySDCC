...
/* ./.libs/lt-sdobjcopy.c - temporary wrapper executable for .libs/sdobjcopy.exe
   Generated by libtool (GNU libtool 1.3134 2009-11-29) 2.2.7a

   The sdobjcopy program cannot be directly executed until all the libtool
   libraries that it depends on are installed.

   This wrapper executable should never be moved out of the build directory.
   If it is, it will not operate correctly.

   Currently, it simply execs the wrapper *script* "/bin/sh sdobjcopy",
   but could eventually absorb all of the scripts functionality and
   exec .libs/sdobjcopy.exe directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "sdobjcopy.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# sdobjcopy - temporary wrapper script for .libs/sdobjcopy.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool 1.3134 2009-11-29) 2.2.7a\n", f);
  fputs ("#\n", f);
  fputs ("# The sdobjcopy program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  generated_by_libtool_version='2.2.7a'\n", f);
  ...
  fputs ("    fi\n", f);
  fputs ("\n", f);
  fputs ("    file=`$ECHO \"$file\" | /bin/sed 's%^.*/%%'`\n", f);
  fputs ("    file=`ls -ld \"$thisdir/$file\" | /bin/sed -n 's/.*-> //p'`\n", f);
  fputs ("  done\n", f);
  fputs ("\n", f);
  ...
  fputs ("    *[\\\\/].libs ) thisdir=`$ECHO \"$thisdir\" | /bin/sed 's%[\\\\/][^\\\\/]*$%%'` ;;\n", f);
  fputs ("    .libs )   thisdir=. ;;\n", f);
  fputs ("    esac\n", f);
  fputs ("  fi\n", f);
  fputs ("\n", f);
