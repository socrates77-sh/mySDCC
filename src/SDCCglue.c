...
/*-----------------------------------------------------------------*/
void printChar(struct dbuf_s *oBuf, const char *s, int plen)
{
  int i;
  int pplen = 0;
  char buf[100];
...
/*-----------------------------------------------------------------*/
void printChar16(struct dbuf_s *oBuf, const TYPE_TARGET_UINT *s, int plen)
{
  int pplen = 0;
...
/*-----------------------------------------------------------------*/
void printChar32(struct dbuf_s *oBuf, const TYPE_TARGET_ULONG *s, int plen)
{
  int pplen = 0;
...
/*-----------------------------------------------------------------*/
void printIvalType(symbol *sym, sym_link *type, initList *ilist, struct dbuf_s *oBuf)
{
  value *val;
...
/*-----------------------------------------------------------------*/
int printIvalChar(symbol *sym, sym_link *type, initList *ilist, struct dbuf_s *oBuf, const char *s, bool check)
{
  value *val;
...
/*-----------------------------------------------------------------*/
int printIvalChar16(symbol *sym, sym_link *type, initList *ilist, struct dbuf_s *oBuf, const TYPE_TARGET_UINT *s, bool check)
{
  value *val;
  size_t size = DCL_ELEM(type);
  TYPE_TARGET_UINT *p;
...
/*-----------------------------------------------------------------*/
int printIvalChar32(symbol *sym, sym_link *type, initList *ilist, struct dbuf_s *oBuf, const TYPE_TARGET_ULONG *s, bool check)
{
  value *val;
  size_t size = DCL_ELEM(type);
  TYPE_TARGET_ULONG *p;
...
/*-----------------------------------------------------------------*/
void printIvalArray(symbol *sym, sym_link *type, initList *ilist, struct dbuf_s *oBuf, bool check)
{
  value *val;
  initList *iloop;
  unsigned int size = 0;
...
/*-----------------------------------------------------------------*/
void printIvalFuncPtr(sym_link *type, initList *ilist, struct dbuf_s *oBuf)
{
  value *val;
  char *name;
  int size;
...
/*--------------------------------------------------------------------*/
int printIvalCharPtr(symbol *sym, sym_link *type, value *val, struct dbuf_s *oBuf)
{
  int size = 0;
  char *p;
...
/*-----------------------------------------------------------------*/
void printIvalPtr(symbol *sym, sym_link *type, initList *ilist, struct dbuf_s *oBuf)
{
  value *val;
  int size;
...
/*-----------------------------------------------------------------*/
void printIval(symbol *sym, sym_link *type, initList *ilist, struct dbuf_s *oBuf, bool check)
{
  sym_link *itype;
...
/*-----------------------------------------------------------------*/
void emitStaticSeg(memmap *map, struct dbuf_s *oBuf)
{
  symbol *sym;
  set *tmpSet = NULL;
...
/*-----------------------------------------------------------------*/
void createInterruptVect(struct dbuf_s *vBuf)
{
