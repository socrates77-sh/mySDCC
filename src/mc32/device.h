...
typedef struct MC32_device
{
	...
	int mc32_maxRAMaddress;  /* maximum value for a data address */
...
MC32_device *mc32_init_pic(char *pic_type);
int mc32_picIsInitialized(void);
char *mc32_processor_base_name(void);
int MC32_IS_CONFIG_ADDRESS(int addr);
