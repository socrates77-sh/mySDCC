...
pBlock *mc32_newpCodeChain(memmap *cm, char c, pCode *pc); // Create a new pBlock
void mc32_printpBlock(FILE *of, pBlock *pb);				  // Write a pBlock to a file
void mc32_printpCode(FILE *of, pCode *pc);				  // Write a pCode to a file
void mc32_addpCode2pBlock(pBlock *pb, pCode *pc);		  // Add a pCode to a pBlock
void mc32_addpBlock(pBlock *pb);							  // Add a pBlock to a pFile
void mc32_unlinkpCode(pCode *pc);
void mc32_copypCode(FILE *of, char dbName); // Write all pBlocks with dbName to *of
void mc32_movepBlock2Head(char dbName);	 // move pBlocks around
...
struct reg_info *mc32_getRegFromInstruction(pCode *pc);

char *mc32_get_op(pCodeOp *pcop, char *buff, size_t buf_size);
...
extern pCodeOpReg mc32_pc_status;
extern pCodeOpReg mc32_pc_intcon;
extern pCodeOpReg mc32_pc_fsr;
extern pCodeOpReg mc32_pc_fsr0l;
extern pCodeOpReg mc32_pc_fsr0h;
extern pCodeOpReg *mc32_pc_indf; /* pointer to either mc32_pc_indf_ or mc32_pc_indf0 */
extern pCodeOpReg mc32_pc_indf_;
extern pCodeOpReg mc32_pc_indf0;
extern pCodeOpReg mc32_pc_pcl;
extern pCodeOpReg mc32_pc_pclath;
extern pCodeOpReg mc32_pc_wsave; /* wsave, ssave and psave are used to save W, the Status and PCLATH*/
extern pCodeOpReg mc32_pc_ssave; /* registers during an interrupt */
extern pCodeOpReg mc32_pc_psave; /* registers during an interrupt */

extern pFile *mc32_the_pFile;
extern pCodeInstruction *mc32_pic14Mnemonics[MAX_PIC14MNEMONICS];
