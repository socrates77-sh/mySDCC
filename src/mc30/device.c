...
#define DEVICE_FILE_NAME "mc3xdevices.txt" //zwr
...
find_device (char *pic_name)
{
  ...
  //zwr
  //printSet(userIncDirsSet);
  //printSet(includeDirsSet);
  //printSet(libDirsSet);
...
#if 1
	/* heading */
	fprintf(stderr, "\nMC3X processors and their characteristics:\n\n");//zwr
