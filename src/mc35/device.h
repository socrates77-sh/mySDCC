...
typedef struct MC35_device
{
	...
	int mc35_maxRAMaddress;  /* maximum value for a data address */
...
MC35_device *mc35_init_pic(char *pic_type);
int mc35_picIsInitialized(void);
char *mc35_processor_base_name(void);
int MC35_IS_CONFIG_ADDRESS(int addr);
