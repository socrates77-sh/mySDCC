...
pBlock *mc35_newpCodeChain(memmap *cm, char c, pCode *pc); // Create a new pBlock
void mc35_printpBlock(FILE *of, pBlock *pb);				  // Write a pBlock to a file
void mc35_printpCode(FILE *of, pCode *pc);				  // Write a pCode to a file
void mc35_addpCode2pBlock(pBlock *pb, pCode *pc);		  // Add a pCode to a pBlock
void mc35_addpBlock(pBlock *pb);							  // Add a pBlock to a pFile
void mc35_unlinkpCode(pCode *pc);
void mc35_copypCode(FILE *of, char dbName); // Write all pBlocks with dbName to *of
void mc35_movepBlock2Head(char dbName);	 // move pBlocks around
...
struct reg_info *mc35_getRegFromInstruction(pCode *pc);

char *mc35_get_op(pCodeOp *pcop, char *buff, size_t buf_size);
...
extern pCodeOpReg mc35_pc_status;
extern pCodeOpReg mc35_pc_intcon;
extern pCodeOpReg mc35_pc_fsr;
extern pCodeOpReg mc35_pc_fsr0l;
extern pCodeOpReg mc35_pc_fsr0h;
extern pCodeOpReg *mc35_pc_indf; /* pointer to either mc35_pc_indf_ or mc35_pc_indf0 */
extern pCodeOpReg mc35_pc_indf_;
extern pCodeOpReg mc35_pc_indf0;
extern pCodeOpReg mc35_pc_pcl;
extern pCodeOpReg mc35_pc_pclath;
extern pCodeOpReg mc35_pc_wsave; /* wsave, ssave and psave are used to save W, the Status and PCLATH*/
extern pCodeOpReg mc35_pc_ssave; /* registers during an interrupt */
extern pCodeOpReg mc35_pc_psave; /* registers during an interrupt */

extern pFile *mc35_the_pFile;
extern pCodeInstruction *mc35_pic14Mnemonics[MAX_PIC14MNEMONICS];
