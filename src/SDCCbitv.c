...
/*-----------------------------------------------------------------*/
int bitVectBitsInCommon(const bitVect *bvp1, const bitVect *bvp2)
{
  int elements;
  unsigned int *p1, *p2;
...
/*-----------------------------------------------------------------*/
int bitVectIsZero(const bitVect *bvp)
{
  int i;
...
/*-----------------------------------------------------------------*/
int bitVectnBitsOn(const bitVect *bvp)
{
  int count = 0;
  unsigned int *p1;
  int elements;
...
/*-----------------------------------------------------------------*/
int bitVectFirstBit(const bitVect *bvp)
{
  int i;
  int index;
